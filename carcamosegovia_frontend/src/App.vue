  ...
  <div>
    <div class="form-row">
      <div class="col">
        ...
        <input type="date" id="txt_fechanacimiento" name="txt_fechanacimiento" aria-describedby="ayuda_fecha_nacimiento" class="form-control" v-model="formData.fechanacimiento" placeholder="Fecha de Nacimiento">
